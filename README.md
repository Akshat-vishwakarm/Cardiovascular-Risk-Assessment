...
Loads the processed cardiovascular dataset
...
Performs Random Forest hyperparameter tuning

Evaluates test accuracy and ROC-AUC

Finds a decision threshold using cross-validation and F1 score
